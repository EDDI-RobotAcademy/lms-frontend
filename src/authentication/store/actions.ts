...
export type AuthenticationActions = {
  ...
  requestRedisPurchaseTicketToDjango(
    context: ActionContext<AuthenticationState, any>,
    ticketInfo: { usertoken: string; ticket: string }
  ): Promise<any>;
  requestRedisUpdateCherryToDjango(
    context: ActionContext<AuthenticationState, any>,
    cherryInfo: { usertoken: string; cherry: string }
  ): Promise<any>;
  ...
  requestReadyKakaoPayRedirection(
    context: ActionContext<AuthenticationState, any>,
    readyInfo: { amount: string; approval_url: string }
  ): Promise<void>;
  requestApproveKakaoPayRedirection(
    context: ActionContext<AuthenticationState, any>,
    approveInfo: { tid: string; pg_todken: string }
  ): Promise<void>;
...
const actions: AuthenticationActions = {
  ...
  async requestRedisGetPaidMemberTypeToDjango(
    context: ActionContext<AuthenticationState, any>,
    usertoken: string
  ): Promise<any> {
    try {
      const response = await axiosInst.djangoAxiosInst.post(
        "/google_oauth/redis-get-paid-member-type",
        { usertoken }
      );
  ...
  async requestRedisGetNicknameToDjango(
    context: ActionContext<AuthenticationState, any>,
    usertoken: string
  ): Promise<any> {
    try {
      const response = await axiosInst.djangoAxiosInst.post(
        "/google_oauth/redis-get-nickname",
        { usertoken }
      );
  ...
  async requestRedisGetCherryToDjango(
    context: ActionContext<AuthenticationState, any>,
    usertoken: string
  ): Promise<any> {
    try {
      const response = await axiosInst.djangoAxiosInst.post(
        "/google_oauth/redis-get-cherry",
        { usertoken }
      );
  ...
  async requestRedisPurchaseTicketToDjango(
    context: ActionContext<AuthenticationState, any>,
    ticketInfo: { usertoken: string; ticket: string }
  ): Promise<any> {
    try {
      const response = await axiosInst.djangoAxiosInst.post(
        "/google_oauth/redis-purchase-ticket",
        ticketInfo
      );
  ...
  async requestRedisUpdateCherryToDjango(
    context: ActionContext<AuthenticationState, any>,
    cherryInfo: { usertoken: string; cherry: string }
  ): Promise<any> {
    try {
      const response = await axiosInst.djangoAxiosInst.post(
        "/google_oauth/redis-update-cherry",
        cherryInfo
      );
  ...
  async requestRedisPurchaseCherryToDjango(
    context: ActionContext<AuthenticationState, any>,
    cherryInfo: { usertoken: string; cherry: string }
  ): Promise<any> {
    try {
      const response = await axiosInst.djangoAxiosInst.post(
        "/google_oauth/redis-purchase-cherry",
        cherryInfo
      );
  ...
  async requestLogoutToDjango(
    ...
    try {
      const res = await axiosInst.djangoAxiosInst.post("/google_oauth/logout", {
        userToken: userToken,
      });
  ...
  async requestApproveKakaoPayRedirection(
    context: ActionContext<AuthenticationState, any>,
    approveInfo: { tid: string; pg_todken: string }
  ): Promise<any> {
    try {
      const response = axiosInst.djangoAxiosInst.post(
        "/google_oauth/approveKakaoPay",
        approveInfo
      );
      return response;
    } catch (error) {
